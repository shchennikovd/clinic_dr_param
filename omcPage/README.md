...
- самостоятельно спроектировано поведение страницы на промежуточных разрешениях, поскольку заказчиком были предоставлены макеты только для **1920 px** и **360 px**;
...
| `Dockerfile` | Конфигурация Docker-контейнера для публикации демонстрационной версии страницы на Render. Используется для предоставления доступа к результату разработки без локального запуска проекта. |
